    ...
    BEGIN
        ...
        LOOP
            CASE WHEN I = 1 THEN TEXTO  := 'TRG_BLQALTERITC_COT_JGD';
                 ...
                 WHEN I = 18 THEN TEXTO := 'TRG_DLT_TGFVOA';
            END CASE;
...
/* DESABILITAR CONSTRAINT'S */
  ...
  /*    FOR I IN 1..1
        LOOP *
              CASE
                 WHEN I = 1 THEN*/ TEXTO  := 'ALTER TABLE TCIMOV MODIFY CONSTRAINT FK_TCIMOV_CODBEM_TCIBEM DISABLE';
                /* WHEN I = 2 THEN /*TEXTO  := 'ALTER TABLE TCIMOV MODIFY CONSTRAINT FK_TCISAL_CODBEM_TCIBEM DISABLE';
                 ...
                 WHEN I = 10 THEN *TEXTO := 'ALTER TABLE AD_FABRICANTES MODIFY CONSTRAINT AD_FK_503C166AB9A050976680 DISABLE';*/
             /* END CASE;*/
...
/* FIM DO BLOCO */
    BEGIN
     ...
     /* FOR I IN 1..1
        LOOP
              CASE
                 WHEN I = 1 THEN */TEXTO  := 'ALTER TABLE TCIMOV MODIFY CONSTRAINT FK_TCIMOV_CODBEM_TCIBEM ENABLE';
            /*   WHEN I = 2 THEN/* TEXTO  := 'ALTER TABLE TCIMOV MODIFY CONSTRAINT FK_TCISAL_CODBEM_TCIBEM ENABLE';
               ...
               WHEN I = 10 THEN TEXTO := 'ALTER TABLE AD_FABRICANTES MODIFY CONSTRAINT AD_FK_503C166AB9A050976680 ENABLE';*/
           /* END CASE;*/
            EXECUTE IMMEDIATE TEXTO;
            DBMS_OUTPUT.PUT_LINE('Comando   '||TEXTO||'   executado com sucesso!!');
        --  IF I = 9 THEN
