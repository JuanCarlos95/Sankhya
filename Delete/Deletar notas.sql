    ...
    BEGIN
        ...
        LOOP
            CASE WHEN I = 1 THEN TEXTO := 'TRG_DLT_TGFMBC';
                 ...
                 WHEN I = 13 THEN TEXTO := 'TRG_DLT_AD_IMPTABITE_JGD';
                 WHEN I = 14 THEN TEXTO := 'TRG_UPT_TGFITE';
                 WHEN I = 15 THEN TEXTO := 'TRG_BLOQLOCALEMPITE_JGD';
                 WHEN I = 16 THEN TEXTO := 'TRG_DLT_TCIIBE';
            END CASE;
...
/* DELETAR NOTAS/PARCEIROS */
    BEGIN
        ...
        DELETE FROM TCIIBE;
        DELETE FROM AD_SERVOS;
        DELETE FROM AD_PRODOS;
